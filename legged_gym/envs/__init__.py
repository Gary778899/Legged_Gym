...
from legged_gym.envs.x2.x2_config import X2FlatCfg, X2FlatCfgPPO, X2FlatNoRandCfg, X2FlatNoRandCfgPPO
...
task_registry.register( "x2", X2Robot, X2FlatCfg(), X2FlatCfgPPO())
task_registry.register( "x2_no_rand", X2Robot, X2FlatNoRandCfg(), X2FlatNoRandCfgPPO())
